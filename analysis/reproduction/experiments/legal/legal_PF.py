...
# --- load data ---
df1 = load_dataset("lex_glue", "ledgar")
...
# -- Train the model
spf1.model_train(lr = 0.0005, epochs = 550, tensorboard = False, early_stopping = False, print_information=True)
...
assert len(unique_categories) == len(np.unique(df1.label)), "Number of unique categories must be K to match predictions 0-19"
